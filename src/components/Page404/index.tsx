...
const Page404 = () => <Page404Styled data-testid="page-404">
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 500 500'>
        <g>
            ...
            />
            <path fill='#f5f5f5' d='M206.71 98.4a1.33 1.33 0 11-1.33-1.33 1.34 1.34 0 011.33 1.33z'/>
            <circle cx='207.14' cy='415.38' r='7.35' fill='#f0f0f0' transform='rotate(-13.28 207.178 415.437)'></circle>
            <path fill='#e6e6e6' d='M204.6 411.09a7.09 7.09 0 00-4.19 1.36 7.34 7.34 0 0010.5 9.23 7.17 7.17 0 00-6.31-10.58z'/>
        </g>
        <g fill='#407BFF'>
        ...
        <g>
            ...
            <circle cx='141.23' cy='116.36' r='21.91' fill='#fff' opacity='0.7'></circle>
            <path
                fill='#407BFF'
            ...
            <path
                ...
                opacity='0.2'
            />
            <circle cx='382.2' cy='376.25' r='19.23' fill='#407BFF' transform='rotate(-76.72 382.179 376.25)'></circle>
            <circle cx='382.2' cy='376.25' r='19.23' fill='#fff' opacity='0.3' transform='rotate(-76.72 382.179 376.25)'></circle>
            <path
                fill='#407BFF'
        ...
        <g>
            ...
            <path
                ...
                opacity='0.2'
            />
            <path fill='#407BFF' d='M312.76 97a46.05 46.05 0 0113.58 2.13s11 18.77 12.3 23.07c-.46 4.24-7.61 11.19-7.61 11.19z'/>
            <path
                fill='#fff'
            ...
            <path
                ...
                opacity='0.8'
            />
            <path fill='#407BFF' d='M326.3 106.21l-4.39-1.47c1 2.57 4.53 5.82 7 7.73-.8-2-1.69-4.1-2.61-6.26z' opacity='0.3'/>
            <path
                fill='#407BFF'
            ...
            <path
                ...
                opacity='0.8'
            />
            <path fill='#263238' d='M312.46 87.48a7.57 7.57 0 11-9.81-4.3 7.58 7.58 0 019.81 4.3z'/>
            <path
                fill='#407BFF'
            ...
            />
            <path fill='#407BFF' d='M311 114.71a2.58 2.58 0 11-1.73-3.21 2.58 2.58 0 011.73 3.21z' opacity='0.3'/>
            <path
                fill='#407BFF'
                ...
                opacity='0.6'
            />
            <path fill='#407BFF' d='M318.29 118.19L309.04 121.84 308.49 120.02 317.73 116.37 318.29 118.19z' opacity='0.5'/>
        </g>
        <g>
            <path
            ...
            <path fill='#407BFF' d='M189.75 344.82L159.56 314.63 184.28 291.37 213.01 320.11 189.75 344.82z' opacity='0.3'/>
            <path
                fill='#407BFF'
            ...
            <path
                ...
                opacity='0.2'
            />
            <path fill='#407BFF' d='M170.28 370.3L134.08 334.1 153.36 329.93 174.45 351.02 170.28 370.3z'/>
        </g>
    </svg>
</Page404Styled>
